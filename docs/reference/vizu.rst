...
<https://colab.research.google.com/github/Yquetzal/tnetwork/blob/master/demo_visu.ipynb>`_.


Vizualising graphs is already a difficul problem in itself, and adding the
dynamic makes it an ever harder task.
